...
const questions = [
  ...
  {
   question: "Which gas is needed in photosynthesis?",
   options: ["Oxygen", "Carbon dioxide", "Hydrogen", "Carbon Monoxide"],
   correctAnswer: 1
 
   question: "What is the substance that makes leaves look green?",
   options: ["Green colour", "Palisade", "Chlorophyll", "Chloroplasts"],
   correctAnswer: 2
  }
];
